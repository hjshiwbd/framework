...
public class CreateStructFolders
{
	...
	{
		// 模块的包名
		String pkgModule = "com.iispace.web.portal";
		// 模块的mapper包名,可以不用改
		String pkgMapper = "com.iispace.web.portal.mapper";
		// 模块名, 全小写或驼峰命名法
		String module = "datadict";
		// 作者
		String author = "hjin";

		CreateStructFolders structCreater = new CreateStructFolders(pkgModule,
				pkgMapper, module, author);

		structCreater.execute();
	}
