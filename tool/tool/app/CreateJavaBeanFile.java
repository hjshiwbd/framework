...
public class CreateJavaBeanFile
{
    ...
    public static void main(String[] args)
    {
        ...
        CreateJavaBeanFile c = new CreateJavaBeanFile(getConn(), tableName,
                beanFileName, packageName, folderPath, DB_TYPE_MYSQL);
        c.createBeanFile(false);
        ...
        MybatisSqlGenerator mybatis = new MybatisSqlGenerator(getConn(),
                ...
                DB_TYPE_MYSQL);
        mybatis.createMapperFile(false);
    }
     ...
     * @param folderPath
     */
    public CreateJavaBeanFile(Connection conn, String tableName,
            String beanFileName, String packageName, String folderPath,
            String dbtype)
    {
